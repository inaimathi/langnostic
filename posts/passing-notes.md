...
## <a name="step-get-some-friends-and-computers-together"></a>Step 1: Get Some Friends and Computers together
...
## <a name="step-get-gnupg"></a>Step 2: Get GnuPG
...
## <a name="step-make-some-keys"></a>Step 3: Make some keys
...
## <a name="step-share-your-keys"></a>Step 4: Share Your Keys
...
## <a name="step-send-a-message"></a>Step 5: Send A Message
...
## <a name="step-read-a-message"></a>Step 6: Read A Message
...
## <a name="boss-fight"></a>Boss Fight
...
## <a name="secret-boss-fight"></a>Secret Boss Fight
...
## <a name="secret-boss-fight-stage-"></a>Secret Boss Fight -- Stage 2
...
## <a name="secret-boss-fight-final-stage"></a>Secret Boss Fight -- Final Stage
