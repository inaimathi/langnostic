...
### <a name="anecdote-time"></a>Anecdote Time
...
### <a name="the-right-thing"></a>The Right Thing...
...
## <a name="bidirectionally-agnostic-components"></a>Bi-Directionally Agnostic Components
...
## <a name="simpler-components"></a>Simpler Components
...
## <a name="rich-client-side"></a>Rich Client Side
...
## <a name="html-and-javascript"></a>HTML and Javascript
...
### <a name="what-the-frameworks-dont"></a>What The Frameworks Do`(n't)?`
