...
**Week 7** Is where you'll be asked to exit if there's judged to be no shot. Don't take it personally, but have it in mind, and see if you can build something together by then.
...
- "Figure out your values and chemistry, as your work on problem ideas"
- Trajectory slide is reiterated. It's _normal_ to work on an idea, then pivot, track out with someone, then track back in, then track out with someone else. You don't have to be moving at anyone else's.
...
- Week 7, 8, 9 aecured pre-seed fundnig

This is an atypical, but possible trajectory. They had the advantage of having done team formation/chemistry exploration and customer outreach before their Antler cohort started.x
...
- We're a VC, we're here to invest in the storngest founders
- We're a lean team
...
- Likes cave diving (that sounds horrifying, but he clearly has grit)
- Background in software engineering/data science

Esteban Valencia

- Looking for a cofounder who wants to be aggressive in growing a business that solves a problemx
- Currentarea: AI agent applications in e-commerce
...
- Do you need a co-founder?
  - Data-wise, yes. In descending order of founder team-size, the most common unicorns come from 2, 3, 1, 4, 5, 6, 10 person teams. (No details on the 10 person team, and I have no idea how you go about getting anything done with a responsibility base that diffuse. Maybe this was like a bunch of sales peeps, and sales is really parallelizable once you have your product set up?)
...
- Different ways founders have formed teams at antler:
  - Netnow: founders met at antler, had a new idea togeter (this is the most common story)
...
- Is there any situation where you'd recommend someone bring on a third founder?
  - Yes, we've recommended that to Genuine Taste, because they were a pair of business founders. They didn't do that.
...
- Cybersecurity security for high networth individuals
