Ok, so I've been doing more intermittent work on [`catwalk`](TODO - github). There's a bunch of other stuff happening in life, so the project isn't going _exactly_ as well as I wanted, but I'm making progress.
