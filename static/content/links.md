...
- [Nix - purely functional package manager](http://nixos.org/nix/)
- [Guix - Nix for GNU fans](http://www.gnu.org/software/guix/)
- [Conkeror - Firefox for Emacs users](http://conkeror.org/)
...
- [REBOL in Ten Steps](http://www.rebol.com/rebolsteps.html)
- [REBOL3 Guide](http://www.rebol.com/r3/docs/guide.html)
...
- [Why's Guide](http://mislav.uniqpath.com/poignant-guide/book/)

### Erlang

- [Armstrong on Software](http://armstrongonsoftware.blogspot.com/)
- [Erlang + OTP](http://ftp.sunet.se/pub/lang/erlang/)
...
- [Java](http://www.erlang.org/doc/apps/jinterface/java/index.html)
...
- [Seaside 3.0 In Pharo](http://seaside.gemstone.com/tutorial.html)
- [Terse Guide to Seaside](http://onsmalltalk.com/terse-guide-to-seaside)
...
- [IDLE Download](http://www.python.org/download/)
- [mod_python tutorial](http://webpython.codepoint.net/mod_python_tutorial)
- [mod_python docs](http://www.modpython.org/live/current/doc-html/)
- [web.py](http://webpy.org/)
- [tornado](http://www.tornadoweb.org/)

### Common Lisp

- [Indenting Lisp](http://dept-info.labri.u-bordeaux.fr/~idurand/enseignement/PFS/Common/Strandh-Tutorial/indentation.html)
- [The CLiki](http://www.cliki.net/CL-WIKI)
- [Hyperspec Symbol List](http://www.lispworks.com/documentation/HyperSpec/Front/X_AllSym.htm)
- [Scheme vs. Common Lisp comparison](http://community.schemewiki.org/?scheme-vs-common-lisp)
...
- [Bigloo Scheme](http://www-sop.inria.fr/mimosa/fp/Bigloo/)
- [Gambit](http://dynamo.iro.umontreal.ca/~gambit/wiki/index.php/Main_Page)
- [Termite](http://code.google.com/p/termite/)
...
- [Redo Mode](http://www.emacswiki.org/emacs/RedoMode)
- [auto-complete mode](http://www.emacswiki.org/emacs/auto-complete.el)
- [autopair mode](http://www.emacswiki.org/emacs/AutoPairs)
- [paredit](http://www.emacswiki.org/emacs/ParEdit)
- [multi-eshell mode](http://www.emacswiki.org/emacs/multi-shell.el)
- [Emacs Extension Guide(pdf)](http://www.emacs.uniyar.ac.ru/doc/O'reilly_emacs/writing%20gnu%20emacs%20extensions.pdf)
- [Xah's Emacs Guide](http://xahlee.org/emacs/emacs.html)
- [Xah's Elisp Guide](http://xahlee.org/emacs/elisp.html)

##### Emacs Language-specific Modes

- [SLIME - Superior Lisp Interaction Mode for Emacs](http://common-lisp.net/project/slime/)
- [Quack - enhanced Scheme mode for Emacs](http://www.neilvandyke.org/quack/)
- [Clojure Mode and Clojure Test Mode](https://github.com/technomancy/clojure-mode/)
- [swank-clojure](https://github.com/technomancy/swank-clojure)
- [js2 mode](http://www.emacswiki.org/emacs/Js2Mode)
- [Setting up node environment in Emacs](http://blog.deadpansincerity.com/2011/05/setting-up-emacs-as-a-javascript-editing-environment-for-fun-and-profit/)
- [Haskell Mode](http://projects.haskell.org/haskellmode-emacs/)

*Ruby and Erlang each come with their own modes, and recent Emacs versions ship with a built-in Python mode and shell. Smalltalk uses its own environment (though GNU Smalltalk does have [its own mode](http://www.gnu.org/software/smalltalk/manual/html_node/Emacs.html)), and I'd really rather not talk about PHP. If you're writing in it, chances are you're using Eclipse or some other IDE anyway.*

## Inaimathi Elsewhere

- [github](https://github.com/Inaimathi)
- [deviantArt](http://inaimathi.deviantart.com/)
- [SO profile](http://stackoverflow.com/users/190887/inaimathi)
- [Cliki entry](http://www.cliki.net/Inaimathi)
- [BGG](http://boardgamegeek.com/user/Inaimathi)
