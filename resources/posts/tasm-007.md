...
So the real question, in terms of whether ChatGPT can be useful to me here, is: would you rather have your blog post be shit, but spend 45 minutes less writing it? I can see situations where the answer to that question would be "yes", but it's not this one for me. I intend to run a few more experiments of this kind over the next little while. You _might_ end up seeing an AI-generated notes piece up on [the main site](https://inaimathi.ca/) eventually, but it'll be after I both reduce the shit level of the output _by a lot_ and reduce the amount of time a trip through the process takes. 
